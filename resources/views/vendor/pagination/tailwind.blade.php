                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        ...
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-base font-extrabold text-gray-500 bg-blue-300 border border-gray-300 cursor-default leading-5"><u> {{ $page }}</u></span>
                                    </span>
                                @else
