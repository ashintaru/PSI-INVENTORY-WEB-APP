            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <section class="space-y-4 ">
                    @if (!is_null($recieve))
                        <nav class="justify-between px-4 py-3 text-gray-700 border border-gray-200 rounded-lg sm:flex sm:px-5 bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 sm:mb-0">
                                ...
                                <li aria-current="page">
                                    ...
                                    <a href="{{URL('view-recieve-unit/'.$recieve->car->vehicleidno)}}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{$recieve->car->vehicleidno}}</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        ...
                        <div class="overflow-x-auto p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            <div class="flex justify-between">
                                <div>
                                    ...
                                    <p>{{Carbon\Carbon::parse($recieve->car->datein)->isoformat('MMMM Do YYYY h:mm a')}}</p>
                                </div>
                                <div>
                                    <span class="text-xs font-medium">Date Encode</span>
                                    <p>{{Carbon\Carbon::parse($recieve->car->dateEncode)->isoformat('MMMM Do YYYY ')}}</p>

                                </div>
                            </div>
                        </div>
                        <div class="overflow-x-auto p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            <form method="POST" action="{{URL('update-cars-Personel/'.$recieve->car->vehicleidno)}}" class="space-y-2">
                                @csrf
                                @method('PUT')
                        ...
                        <div class="flex flex-row overflow-x-auto p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                            <div class="space-y-2 ">
                                <div class="grid md:grid-cols-3 md:gap-6">
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text"  id="UnitTag" value="{{ $recieve->car->tag }}" name="exteriorcolor"  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" disabled/>
                                        <label for="UnitTag" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Unit Client Tag</label>
                                    </div>
                                </div>
                                <div class="grid md:grid-cols-3 md:gap-6">
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text" id="vehicleidno" value="{{$recieve->car->vehicleidno }}" name="vehicleidno"   class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text" value="{{ $recieve->car->engineno }}" id="engineno" name="engineno" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text" id="csno" name="csno" value="{{ $recieve->car->csno }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" id="modeldescription"  name="modeldescription" value="{{ $recieve->car->modeldescription }}"  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                                ...
                                <div class="grid md:grid-cols-3 md:gap-6">
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="number" min="2000" max="3000"  id="mmpcmodelyear" name="mmpcmodelyear" value="{{ $recieve->car->mmpcmodelyear }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text" id="mmpcoptioncode" name="mmpcoptioncode" value="{{ $recieve->car->mmpcoptioncode }}"  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                                ...
                                <div class="grid md:grid-cols-2 md:gap-6">
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text" id="extcolorcode" name="extcolorcode" value="{{ $recieve->car->extcolorcode }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text"  id="exteriorcolor" value="{{ $recieve->car->exteriorcolor }}" name="exteriorcolor"  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                                ...
                                <div class="grid md:grid-cols-4 md:gap-6">
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text"min="2000" max="3000" maxlength="4" minlength="4" value="{{ $recieve->car->bilingdocuments }}" id="bilingdocuments" name="bilingdocuments" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text" id="productioncbunumber"  value="{{ $recieve->car->productioncbunumber }}" name="productioncbunumber" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                                    ...
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input type="text"  value="{{ $recieve->car->vehiclestockyard }}" name="vehiclestockyard" id="vehiclestockyard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                            ...
                            <div class="flex flex-col space-y-1">
                                <a href="{{URL('createloosetools/'.$recieve->car->vehicleidno)}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 <a href="{{URL('createsettools/'.$recieve->car->vehicleidno)}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                                       <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                                       <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                                    </svg>
                                 ...
                                 <a href="{{URL('createdamage/'.$recieve->car->vehicleidno)}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                                       <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                                       <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                                    </svg>
                                 ...
                                 @if ($recieve->car->blocking && $recieve->car->recieveBy && $recieve->car->recieveBy != "empty" )
                                    <form action="{{URL('default-approve/'.$recieve->car->vehicleidno)}}" method="POST" >
                                        @csrf
                        ...
                        @if ($recieve->settools && $recieve->loosetools && $recieve->damage && $recieve->car->blocking && $recieve->car->recieveBy && $recieve->car->receiveBy != "empty" )
                            <div class="overflow-x-auto p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                                <form method="POST" action="{{URL('update-inventory/'.$recieve->car->vehicleidno)}}" class="space-y-2">
                                    @csrf
                                    <div class="flex-col space-y-3">
                                        <h3 class="mb-4 font-semibold text-gray-900 dark:text-white">Approve Unit</h3>
                                        <button type="submit" name="approved" value="1" class="inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">Approve</button>
                                    </div>
                                </form>
                            </div>
                        @else
