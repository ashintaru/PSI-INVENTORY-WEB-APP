<div>
    <form  class="flex flex-col space-y-4" id="fileUploadForm" class="" action="{{ URL('uploadInvoice') }}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <button type="submit" id="submit"  class="mr-4 py-2 px-4 w-1/5   rounded-full file:border-0 text-sm file:font-semibold hover:bg-green-100 bg-green-50 text-green-700 ">
        Import
    </button>
</form>
