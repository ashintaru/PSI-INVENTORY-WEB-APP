<x-app-layout>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Raw Units</span>
            </div>
          </li>
        </ol>
    </nav>
    ...
    {{-- <div class="inline-flex">
        <x-navigation.nav-link :url="URL('rawdata')">
            Databased
        </x-navigation.nav-link>
    </div> --}}
    <div class="p-2">
        <form action="{{URL('searchRawData')}}" method="post">
            @csrf
            <x-search-bar />
        </form>
    </div>
    <div class="p-2">
        <form class="flex gap-4" action="{{URL('filter-rawdata')}}" method="POST">
            @csrf
            <div date-rangepicker class="flex items-center">
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                        ...
                        <input @if ($start) value="{{$start}}"@endif name="start"  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
                </div>
