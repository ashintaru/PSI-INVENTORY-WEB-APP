<x-app-layout>
    ...
    <div class="mt-2 gap-3 flex justify-around">
        <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            <div class="flex justify-between mb-3">
              <div class="flex items-center">
                <div class="flex justify-center items-center">
                  <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pr-1">Recieving Unit's Progress</h5>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
              <div class="grid grid-cols-3 gap-3 mb-2">
                <a href="{{URL('disapproved-units')}}">
                    <dl class="bg-orange-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                    <dt id="pending" class="w-8 h-8 rounded-full bg-orange-100 dark:bg-gray-500 text-orange-600 dark:text-orange-300 text-sm font-medium flex items-center justify-center mb-1"></dt>
                    <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">Pending</dd>
                    </dl>
                </a>
                <a href="{{URL('approved-units')}}">
                    <dl class="bg-teal-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                    <dt id="done" class="w-8 h-8 rounded-full bg-teal-100 dark:bg-gray-500 text-teal-600 dark:text-teal-300 text-sm font-medium flex items-center justify-center mb-1"></dt>
                    <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">Approved</dd>
                    </dl>
                </a>
                <a href="{{URL('total-units')}}">
                  <dl class="bg-blue-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                    ...
                    <dd class="text-blue-600 dark:text-blue-300 text-sm font-medium">Total Unit's</dd>
                  </dl>
                </a>
            ...
            <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
              <div class="flex justify-between items-center pt-5">
                <!-- Button -->
                <span class="text-sm font-extrabold">As of today:</span>
                <a
                  href="#"
          ...
          {{-- <div class=" w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            <div class="flex justify-between">
              <div>
                ...
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">Sorage Level</p>
              </div>
              <div
...
<script>
    ...
    window.addEventListener("load", function() {
        $cars =  {!! json_encode($cars , JSON_HEX_TAG) !!};
        $done = 0, $pending = 0 ,$total = 0,$pendingperc=0,$doneperc=0;

        for (const x in $cars) {
            $total++;
              if($cars[x].havebeenchecked == 1){
                $done++;
              }else{
                $pending++;
             }
        ...
        $doneperc = Math.floor($done / $total * 100).toFixed(2);;
        $pendingperc = Math.floor($pending / $total * 100).toFixed(2); ;
      ...
      const getChartOptions = () => {
          return {
            series: [100, $doneperc,$pendingperc ],
            ...
            labels: ["Total Unit Recieved", "Approve", "Pending"],
            legend: {
              show: true,
              position: "bottom",
