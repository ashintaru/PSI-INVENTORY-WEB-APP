           ...
           @if (!is_null($data))
             @foreach($data as $d)
                 <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                   ...
                   <td class="px-6 py-4">
                       <a href="{{URL('/view'."/".$d->vehicleidno."/"."inv")}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Profile</a>
                       <a href="{{URL('/view'."/".$d->vehicleidno."/"."inv")}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">released</a>
                   </td>
                 </tr>
             @endforeach
           @else
