                     ...
                     <li>
                       ...
                       <ul id="dropdown-inv" class="hidden py-2 space-y-2">
                             <li>
                               ...
                               <span class="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-green-800 bg-green-100 rounded-full dark:bg-green-700 dark:text-gray-300">{{$passedcars}}</span>
                               </a>
                             </li>
                             <li>
                                <a href="{{URL('inventory/fail')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Failed
                                   <span class="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-red-100 rounded-full dark:bg-red-700 dark:text-gray-300">{{$failedcars}}</span>
                               </a>
                             </li>
                       </ul>
                    </li>
