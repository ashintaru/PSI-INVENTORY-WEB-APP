                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li class="inline-flex items-center">
                            @if (isset($blockings))
                                ...
                                <a wire:navigate href="{{URL('block-list/'.$blockings[0]->block->id)}}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                    {{$blockings[0]->block->blockname}}
                                @else
                                    No site
                                </a>
                            @endif
 ...
 --}}
                        ...
                        <li class="inline-flex items-center">
                            @if (isset($blockings))
                                ...
                                @if (count($blockings)!=0)
                                    <a wire:navigate href="{{URL('block-list/'.$blockings[0]->block->site->id)}}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                        {{$blockings[0]->block->site->siteName}}
                                    </a>
                                @else
                                    No Blocking to show
                                @endif
                            @else
                                ...
                                <a wire:navigate href="#" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                    No Block
                                </a>
                            @endif
                        </li>
    ...
    <div class="py-1">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="py-2">
                @if (isset($blockings))
                    {{$blockings->links('pagination::tailwind')}}
                @endif
            </div>
        </div>
    </div>
