        ...
        <form class="p-4 bg-slate-100 w-full" >
            ...
            <div class="flex justify-start">
                <div class="w-full p-3">
                    <input onfocus="this.value=''" wire:model="recievedBy" placeholder="Received by who?" id="recievedBy" class ='block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm'>
            ...
            <div class="flex flex-col justify-start gap-1" >
                <div class="flex flex-col w-full gap-3">
                    <textarea onfocus="this.value=''" wire:model.defer="findings" id="findings"  rows="2" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </textarea>
