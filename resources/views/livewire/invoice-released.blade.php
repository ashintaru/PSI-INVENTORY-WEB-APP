        ...
        <div class=" max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-3">
            ...
            <div class="flex gap-2">
                <div class="overflow-x-auto w-1/2 p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    <form method="POST" action="{{URL('updatecarsreleasedata/')}}" class="space-y-2">
                        @csrf
                ...
                <div class="overflow-x-auto w-1/2 p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    <form method="POST" action="{{URL('updatecarsreleasedata/')}}" class="space-y-2">
                        ...
                        <div class="flex-col space-y-3">
                            ...
                            <input type="text" id="website-admin" name="personel" class="rounded-none roundZed-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500  min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                            </div>
                            <h3 class="mb-4 font-semibold text-gray-900 dark:text-white">Delear</h3>
                            <div class="flex">
                                <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                ...
                                <input type="text" id="website-admin" name="dealer" class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500  min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                                </div>
                            ...
                            <h3 class="mb-4 font-semibold text-gray-900 dark:text-white">Remark</h3>
                            <div class="flex">
                                <textarea id="message" rows="4" name="remark" class="block p-2.5 min-w-0 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
                            </div>
                            <x-primary-button>{{ __('Submit') }}</x-primary-button>
                        </div>
                    </form>
